...
from .routes import (
    analyze, brand, brand3_lab, health, index, report, reports_list, status, takedown, team,
    visual_signature,
)
...
for module in (index, analyze, status, report, reports_list, brand, team, takedown, health, visual_signature, brand3_lab):
